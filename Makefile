...
# MODFILES = mod*.f90
F90FILES = mod_vars.f90 mod_output_routines.f90 src_thomas.f90 src_mesh.f90 src_inco_proj1.f90 src_boco_proj1.f90 src_jacobi.f90 src_residue.f90 src_projeto1.f90
